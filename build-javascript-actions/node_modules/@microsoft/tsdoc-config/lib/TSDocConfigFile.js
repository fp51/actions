...
class TSDocConfigFile {
    ...
    _addTagDefinitionForLoad(parameters) {
        ...
        try {
            ...
            this._reportError({
                messageId: "tsdoc-config-invalid-tag-name" /* ConfigFileInvalidTagName */,
        ...
        if (this._tagDefinitionNames.has(tagDefinition.tagNameWithUpperCase)) {
            this._reportError({
                messageId: "tsdoc-config-duplicate-tag-name" /* ConfigFileDuplicateTagName */,
    ...
    updateParser(configuration) {
        ...
        this.supportForTags.forEach((supported, tagName) => {
            ...
            if (tagDefinition) {
                ...
                this._reportError({
                    messageId: "tsdoc-config-undefined-tag" /* ConfigFileUndefinedTag */,
